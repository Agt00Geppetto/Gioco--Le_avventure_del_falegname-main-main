...
class Monete:
    ...
    def __init__(self,scene):
        ...
        self.scene = scene
        self.m = arcade.load_texture("./assets/moneta.png")
        self.valore_m = 10
        self.m_c = arcade.load_texture("./assets/moneta-corrotta.png")
        self.valore_mc = 15
        self.l = arcade.load_texture("./assets/lingotto.png")
        self.valore_l = 30
        self.l_c = arcade.load_texture("./assets/lingotto-corrotto.png")
        self.valore_l_c = 40
